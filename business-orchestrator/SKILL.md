...
description: Use when someone asks for general business help, describes a problem without an obvious single skill that applies, or asks "where do I start" or "what should I focus on." Routes to the right skill based on symptoms.
---

# Business Orchestrator — Route to the Right Skill
